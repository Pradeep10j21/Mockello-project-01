            ...
            {[
              {
                ...
                description:
                  "Like a forest ecosystem, we nurture long-term relationships between colleges and companies for sustainable career growth.",
              },
              {
                icon: Users,
                title: "Smart Matching",
                description:
                  "Our intelligent algorithm matches student skills with company requirements, ensuring the perfect fit for both parties.",
              },
              {
                icon: Building2,
                title: "Industry Connections",
                description:
                  "Access a vast network of top-tier companies actively seeking fresh talent from premier educational institutions.",
              },
            ].map((feature, index) => (
              <div
                key={index}
                className="card-forest text-center animate-fade-up"
      ...
      <section className="py-20 bg-gradient-canopy text-primary-foreground">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/college/login"
              className="inline-flex items-center justify-center gap-2 bg-sage text-forest-deep px-8 py-4 rounded-xl font-semibold hover:bg-sage-light transition-all duration-300 shadow-medium hover:shadow-glow hover:-translate-y-1"
            >
              Get Started
            ...
            <a
              href="#about"
              className="inline-flex items-center justify-center gap-2 border-2 border-primary-foreground/30 text-primary-foreground px-8 py-4 rounded-xl font-semibold hover:bg-primary-foreground/10 transition-all duration-300"
            >
              Learn More
            </a>
          </div>
